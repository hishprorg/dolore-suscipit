...
[![npm version](https://img.shields.io/npm/v/@hishprorg/dolore-suscipit)](https://img.shields.io/npm/v/@hishprorg/dolore-suscipit)
...
```bash
npm install @hishprorg/dolore-suscipit

# or 

yarn add @hishprorg/dolore-suscipit

# or

pnpm add @hishprorg/dolore-suscipit
```

Import and use it:

```javascript
import { parseSchema } from '@hishprorg/dolore-suscipit';
